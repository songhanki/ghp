...
public class EgovSampleController {
	...
	@RequestMapping(value = "cal1.do")
	public String myTest2() {
	
		return "sample/calendar1";
	}
	...
	public String deptInsert(DeptVO vo) throws Exception {
	...
	public String deptList( ModelMap map  )  throws Exception {
