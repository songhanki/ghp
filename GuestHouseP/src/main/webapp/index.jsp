...
<script>
	...
	$(document).ready(function(){
	    ...
	    $("#sdate1").on("click",function(){
	        
	    });
	 
	     $("#sdate1").on("change",function(e){
	         var end = $( "#edate1" ).datepicker( "option", "minDate", getDate( e.target ) );
	     });
	     
	     $("#edate1").on("change",function(e){
	         
	     });
	     
	     $("#search").on("click",function(){
	         var start = $("#sdate1").val();
	         var end = $("#edate1").val();
	     });    
	});
</script>
                ...
                <div class="input-group">
                    ...
                    <div class="form-group">
			            <div class="input-daterange date" id="datepicker1" style="width: 320px; display: inline-table;">
			              <input type="text" class="form-control" id="sdate1" style="width: 115px;" placeholder="숙박시작" />
			              <span style="display: table-cell; padding: 0px 30px;"> ~ </span>
			              <input type="text" class="form-control" id="edate1" style="width: 115px; border-radius: 3px 0 0 3px;" placeholder="숙박종료" />
			             </div>
		            </div>
                    <select class="custom-select mr-2">
                        <option selected id="person">인원</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
            ...
            <div class="container">
                <div class="mbWrap">
                    <div class="mbBox">
                        ...
                        <tr>
                        	<td>${result.nctitle }</td>
                        </tr>
                        <ul class="mbList">
                            <li><a href="#"> <span class="mbNoti">best</span>${result.nctitle }</a></li>
                        </ul>
                        </c:forEach>
                    </div><!-- mbBox -->
                    <div class="mbBox">
