...
$( function() {
    ...
    $("#btn_submit").click(function() { // 수정완료 버튼 클릭시
...
<form id="frm">
    ...
    <div class="FC AC" style="background-color: #e2e2e2;">
      <h2 class="width460" style="text-align:center">회원정보 수정</h2>
      
      <p class="width460">이메일</p>
      <div class="FR width460">
        <input type="text" name="email" id="email" value="${vo.email}" class="input460" placeholder="이메일 E-mail : " autofocus readonly required/>
      </div>
      ...
      <div class="width460">
        <input type="text" name="name" id="name" value="${vo.name}" class="input460" placeholder="이름 Name : " autofocus readonly />
      </div>

      <p class="width460">생년월일</p>
      <div class="width460">
        <input type="text" name="birthday" id="birthday" value="${vo.birthday} " class="input460" id="birthday" placeholder="생년월일(달력) : yyyy-mm-dd" autofocus />
      </div>

	  <p class="width460">연락처</p>
      <div class="width460">
        <input type="text" name="phone" id="phone" value="${vo.phone} " class="input460" placeholder="연락처 Phone : ( - 자 생략)" autofocus />
      </div>

      <p class="width460">우편번호</p>
      <div class="FR width460">
        <input type="text" name="zipcode" id="zipcode" value="${vo.zipcode} " class="input460" placeholder="우편번호 : " autofocus />
      ...
      <div class="width460">
        <input type="text" name="address" id="address" value="${vo.address} " class="input460" placeholder="주소 : " autofocus />
      </div>

      <p class="width460">상세주소</p>
      <div class="FR JSB width460" style="margin-bottom:20px;">
        <input type="text" name="detailaddress" id="detailaddress" value="${vo.detailaddress} " class="input460" placeholder="상세주소 : " style="width:50%; margin-right:10px;" autofocus />
 		<input type="text" name="extraaddress" id="extraaddress" value="${vo.extraaddress} " class="input460" style="width:50%; margin-left:10px;" placeholder="참고항목 : " autofocus /> 		      
      </div>
