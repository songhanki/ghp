...
<article id="sub">
    ...
    <!--/ sub visual End /-->
    <section id="sub" class="container notice">
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <c:forEach var="result" items="${list }" varStatus="status">
                    <tr>
                        <td>${rownum }</td>
                        <td><a href="noticeDetail.do?ncseq=${result.ncSeq }">${result.ncTitle }</a></td>
                        <td>${result.ncWdate }</td>
                        <td>${result.ncView }</td>
                    </tr>
    ...
    <section class="container mt-5 mb-5 pt-5 pb-5">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item"><a class="page-link active" href="noticeList.do?page_no=${i }">${i }</a></li>
            </c:forEach>
            <li class="page-item"><a class="page-link" href="#">&gt;</a></li>
        </ul>
    </section>
