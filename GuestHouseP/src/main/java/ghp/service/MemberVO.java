...
public class MemberVO {
	...
	private String mb_sleep;
	private String mb_last;
	private String mb_pfimg;
	...
	public String getMb_sleep() {
		return mb_sleep;
	}
	public void setMb_sleep(String mb_sleep) {
		this.mb_sleep = mb_sleep;
	}
	public String getMb_last() {
		return mb_last;
	}
	public void setMb_last(String mb_last) {
		this.mb_last = mb_last;
	}
	public String getMb_pfimg() {
		return mb_pfimg;
	}
	public void setMb_pfimg(String mb_pfimg) {
		this.mb_pfimg = mb_pfimg;
	}
}
